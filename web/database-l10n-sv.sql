...
('sv_SE', 'asia/myanmar','Myanmar (även känt som Burma)'),
...
('sv_SE', 'africa/cape-verde','Kap Verde'),
...
('sv_SE', 'africa/congo-democratic-republic','Kongo-Kinhasa'),
